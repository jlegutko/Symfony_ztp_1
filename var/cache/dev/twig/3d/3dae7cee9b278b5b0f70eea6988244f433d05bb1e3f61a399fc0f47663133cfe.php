...
class __TwigTemplate_fac3cb0ca83aac52fb982d9d19ee9af5b58aa4d4f52ebbcb58309c1a13df7c0b extends \Twig\Template
{
    private $source;
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.category_edit", ["%id%" => ((twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "id", [], "any", true, true)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "id", []), "")) : (""))]), "html", null, true);
        echo "
";
    ...
    ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), 'form_start', ["method" => "PUT", "action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("category_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 9, $this->source); })()), "id", [])])]);
        echo "
    ";
        // line 10
...
";
    ...
    {
        return array (  118 => 19,  112 => 16,  108 => 15,  102 => 12,  97 => 10,  93 => 9,  88 => 8,  79 => 7,  66 => 4,  57 => 3,  27 => 1,);
    }
...
{% block title %}
    {{ 'title.category_edit'|trans({'%id%': category.id|default('')}) }}
{% endblock %}

{% block body %}
    <h1>{{ 'title.category_edit'|trans({'%id%': category.id|default('')}) }}</h1>
    {{ form_start(form, { method: 'PUT', action: url('category_edit', {id: category.id}) }) }}
    {{ form_widget(form) }}
    <div class=\"form-group row float-sm-right\">
    ...
    {{ form_end(form) }}
{% endblock %}", "category/edit.html.twig", "/home/jlegutko/PhpstormProjects/Symfony_ztp/app/templates/category/edit.html.twig");
    }
}
