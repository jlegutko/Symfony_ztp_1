...
class __TwigTemplate_ba28b4bc3ffb7136bdf1ad76531d4f79e99c7d336d58f57620ec55d10117cc55 extends \Twig\Template
{
    private $source;
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.category_delete", ["%id%" => ((twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "id", [], "any", true, true)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "id", []), "")) : (""))]), "html", null, true);
        echo "
";
    ...
    ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), 'form_start', ["method" => "DELETE", "action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("category_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 9, $this->source); })()), "id", [])])]);
        echo "
    ";
        // line 10
...
{% block title %}
    {{ 'title.category_delete'|trans({'%id%': category.id|default('')}) }}
{% endblock %}

{% block body %}
    <h1>{{ 'title.category_delete'|trans({'%id%': category.id|default('')}) }}</h1>
    {{ form_start(form, { method: 'DELETE', action: url('category_delete', {id: category.id}) }) }}
    {{ form_widget(form) }}
    <div class=\"form-group row float-sm-right\">
    ...
    {{ form_end(form) }}
{% endblock %}", "category/delete.html.twig", "/home/jlegutko/PhpstormProjects/Symfony_ztp/app/templates/category/delete.html.twig");
    }
}
