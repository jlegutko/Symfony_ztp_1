...
return $this->services['App\Repository\TaskRepository'] = new \App\Repository\TaskRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
