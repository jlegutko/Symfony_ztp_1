...
include_once $this->targetDirs[3].'/src/DataFixtures/AbstractBaseFixtures.php';
...
include_once $this->targetDirs[3].'/src/DataFixtures/TaskFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\TaskFixtures(), 'groups' => []]]);
