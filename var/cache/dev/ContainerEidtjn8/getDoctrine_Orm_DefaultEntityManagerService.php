...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\CategoryRepository' => function () {
    ...
    return ${($_ = isset($this->services['App\Repository\TaskRepository']) ? $this->services['App\Repository\TaskRepository'] : $this->load('getTaskRepositoryService.php')) && false ?: '_'};
}])));
