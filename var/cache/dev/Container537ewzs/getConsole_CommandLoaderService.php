...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['SensioLabs\\Security\\Command\\SecurityCheckerCommand' => function () {
    $f = function (\SensioLabs\Security\Command\SecurityCheckerCommand $v) { return $v; }; return $f(${($_ = isset($this->services['SensioLabs\Security\Command\SecurityCheckerCommand']) ? $this->services['SensioLabs\Security\Command\SecurityCheckerCommand'] : $this->load('getSecurityCheckerCommandService.php')) && false ?: '_'});
